...
Sell Signal Engine — Priority-based logic (MACD crossover → RSI < 50 → Stop-Loss hit).
Bill-Level Transaction Tracking — Records full buy/sell bill details including broker commissions, SEBON fees, DP charges, and Capital Gain Tax (CGT @ 7.5%).
JWT Authentication — Email/OTP-based signup and secure token-based login.
